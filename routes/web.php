...
Route::group(['middleware'=>'auth'], function(){
	...
	Route::group(['prefix' => 'imoveis'], function(){
		...
		Route::post('/salvarFotos', 'ImoveisController@addFotos')->name('adicionar_fotos_imoveis');
		Route::get('/excluirFoto/{id}', 'ImoveisController@excluirFotos')->name('excluir_fotos_imoveis');
